/* Compile it with
 * rc resource.rc
 * cl /W3 gl_scrn.c gl_draw_logo.c /link /SUBSYSTEM:WINDOWS user32.lib gdi32.lib ^
 * advapi32.lib scrnsave.lib comctl32.lib opengl32.lib glu32.lib resource.res ^
 * /MACHINE:X86 /OUT:lasyard.scr
 *
 * Copy it to %WINDIR%\system32
 */
...
static const char REG_MAIN_KEY[] = "SOFTWARE\\Lasyard\\LasyardScrn";
static const char REG_SPEED_KEY[] = "Spinning Speed";
